...
parser.add_argument("-a", help="Maximum amount of pitch shift applied to the training data. \
                    Default value is set to 5 (which means datas are shifted for random amount between -5 and 5 semitones).",\
...
training.TrainNStepRNN(None, epoch=args.e[0], modelfile=args.f, augment=args.a)

training.TrainNStepCRF(None, epoch=args.e[1], modelfile=args.f, augment=args.a, savefile=args.s)